...
subprojects {
    ...
    cloudstream {
        setRepo(System.getenv("GITHUB_REPOSITORY") ?: "https://github.com/HatsuneMikuUwU/AnimeX")
        authors = listOf("Miku")
    }
    ...
    dependencies {
        ...
        add("implementation", "org.jsoup:jsoup:1.23.2")
        
        // JSON Parsing
        add("implementation", "com.fasterxml.jackson.module:jackson-module-kotlin:2.22.3")
