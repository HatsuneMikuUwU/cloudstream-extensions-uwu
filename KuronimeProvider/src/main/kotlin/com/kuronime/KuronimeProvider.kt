...
class KuronimeProvider : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "$mainUrl/anime/?status=completed&order=update/page/" to "Complete Anime",
        "$mainUrl/anime/?order=popular/page/" to "Most Popular",
        "$mainUrl/anime/?type=Movie&order=update/page/" to "Movies"
    )
