...
open class KuramadriveV1 : Kuramadrive() {
    override val name = "DriveKurama V1"
...
open class PixelDrain : ExtractorApi() {
    ...
    override suspend fun getUrl(
        ...
        val id = Regex("""/(?:u|d)/([a-zA-Z0-9]+)""").find(url)?.groupValues?.getOrNull(1)
        if (id != null) {
...
open class Dropbox : ExtractorApi() {
    override val name = "Dropbox"
    override val mainUrl = "https://www.dropbox.com"
    override val requiresReferer = false
    ...
    override suspend fun getUrl(
        ...
        val directUrl = url.replace("dl=0", "dl=1")
        callback.invoke(
            newExtractorLink(
                name,
                name,
...
open class PikPak : ExtractorApi() {
    override val name = "PikPak"
    override val mainUrl = "https://mypikpak.com"
    override val requiresReferer = false
...
open class MegaNz : ExtractorApi() {
    override val name = "Mega"
    override val mainUrl = "https://mega.co.nz"
    override val requiresReferer = false
